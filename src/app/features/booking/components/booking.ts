...
export class BookingComponent implements OnInit {
  ...
  confirmBooking() {
    if (this.isFormValid()) {
      alert(
        `Réservation confirmée pour ${this.passenger.name} ${this.passenger.surname}! Total: ${this.getTotalPrice()}€`,
      );
      this.router.navigate(['/']); // ici tu peux rediriger vers une page "confirmation"
    }
  }
}
