        ...
        <div class="bg-blue-600 text-white p-4 rounded-lg shadow-lg border border-blue-500">
          <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
              <h4 class="font-semibold text-sm">Installer Fly Cheap</h4>
              <p class="text-blue-100 text-xs mt-1">
                Réservez vos vols rapidement depuis votre écran d'accueil
              </p>
      ...
      <div class="fixed top-0 left-0 right-0 z-40">
        <div class="bg-amber-500 text-white text-center py-2 px-4">
          <div class="flex items-center justify-center gap-2 text-sm">
            ...
            <span>Mode hors ligne - Consultez vos réservations même sans connexion</span>
          </div>
        </div>
      </div>
    }
